...
/**
 * Created by eyeKill on 15/11/28.
 * 原作： http://blog.csdn.net/guolin_blog/article/details/8714621#
 */
...
public class FlowActivity extends Activity implements OnTouchListener {
    public static final int SNAP_VELOCITY = 200;    //滚动显示和隐藏menu时，手指滑动需要达到的速度
    ...
    protected View content;                           //主内容的布局。
    protected View menu;                              //menu的布局。
    ...
    protected void initValues() {
        ...
        //content = findViewById(user_Content);
        //menu = findViewById(user_Menu);
